...
.method public run()V
    ...
    invoke-static {v0}, Landroid/webkit/DeviceMotionService;->access$200(Landroid/webkit/DeviceMotionService;)Landroid/os/Handler;
    ...
    invoke-static {v0}, Landroid/webkit/DeviceMotionService;->access$300(Landroid/webkit/DeviceMotionService;)[F
    ...
    # getter for: Landroid/webkit/DeviceMotionService;->mLastAcceleration:[F
    invoke-static {v2}, Landroid/webkit/DeviceMotionService;->access$300(Landroid/webkit/DeviceMotionService;)[F
    ...
    # getter for: Landroid/webkit/DeviceMotionService;->mLastAcceleration:[F
    invoke-static {v3}, Landroid/webkit/DeviceMotionService;->access$300(Landroid/webkit/DeviceMotionService;)[F
    ...
    # getter for: Landroid/webkit/DeviceMotionService;->mLastAcceleration:[F
    invoke-static {v4}, Landroid/webkit/DeviceMotionService;->access$300(Landroid/webkit/DeviceMotionService;)[F
    ...
    invoke-static {v1}, Landroid/webkit/DeviceMotionService;->access$400(Landroid/webkit/DeviceMotionService;)Ljava/lang/Runnable;
