...
.method private addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    .line 1054
    invoke-direct/range {p0 .. p1}, Landroid/net/wifi/WifiConfigStore;->securityPriority(Landroid/net/wifi/WifiConfiguration;)I
...
.method private readNetworkVariables(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v13, v8, v14}, Landroid/net/wifi/WifiNative;->getNetworkVariable(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v11}, Landroid/net/wifi/WifiSsid;->createFromHex(Ljava/lang/String;)Landroid/net/wifi/WifiSsid;
    ...
    iput-object v11, v0, Landroid/net/wifi/WifiConfiguration;->BSSID:Ljava/lang/String;
    ...
    sget-object v13, Landroid/net/wifi/WifiConfiguration$Protocol;->strings_with_somc_additions:[Ljava/lang/String;

    move-object/from16 v0, p0

    invoke-direct {v0, v9, v13}, Landroid/net/wifi/WifiConfigStore;->lookupString(Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .end local v10    # "vals":[Ljava/lang/String;
    :cond_c
    const/4 v13, 0x0
    ...
    .line 1564
    .restart local v10    # "vals":[Ljava/lang/String;
    move-object v1, v10
    ...
    sget-object v13, Landroid/net/wifi/WifiConfiguration$KeyMgmt;->strings_with_somc_additions:[Ljava/lang/String;
    ...
    .line 1591
    .restart local v9    # "val":Ljava/lang/String;
    sget-object v13, Landroid/net/wifi/WifiConfiguration$PairwiseCipher;->strings_with_somc_additions:[Ljava/lang/String;
    ...
    .line 1605
    .restart local v9    # "val":Ljava/lang/String;
    sget-object v13, Landroid/net/wifi/WifiConfiguration$GroupCipher;->strings_with_somc_additions:[Ljava/lang/String;
    ...
    invoke-virtual {v13, v8, v6}, Landroid/net/wifi/WifiNative;->getNetworkVariable(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v11}, Landroid/net/wifi/WifiConfigStore;->removeDoubleQuotes(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v13, v14, v8}, Landroid/net/wifi/WifiEnterpriseConfig;->migrateOldEapTlsNative(Landroid/net/wifi/WifiNative;I)Z
    ...
    iget-object v13, v0, Landroid/net/wifi/WifiConfiguration;->wapiConfig:Landroid/net/wifi/WifiWapiConfig;

    if-nez v13, :cond_1a

    .line 1634
    new-instance v13, Landroid/net/wifi/WifiWapiConfig;

    invoke-direct {v13}, Landroid/net/wifi/WifiWapiConfig;-><init>()V

    move-object/from16 v0, p1

    iput-object v13, v0, Landroid/net/wifi/WifiConfiguration;->wapiConfig:Landroid/net/wifi/WifiWapiConfig;
    ...
    .line 1637
    .local v12, "wapiCertFields":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    invoke-virtual {v13, v11}, Landroid/net/wifi/WifiWapiConfig;->setWapiPsk(Ljava/lang/String;)V
    ...
    invoke-virtual {v13, v14}, Landroid/net/wifi/WifiWapiConfig;->setWapiPskType(I)V
    ...
    const-string v15, "forbidden_deletion"
    ...
    iput-boolean v13, v0, Landroid/net/wifi/WifiConfiguration;->readOnly:Z
    ...
    invoke-virtual {v13, v14}, Landroid/net/wifi/WifiWapiConfig;->setWapiPsk(Ljava/lang/String;)V
    ...
    .end local v4    # "i$":I
    .end local v7    # "len$":I
    .end local v12    # "wapiCertFields":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/String;>;"
    :catch_0
    move-exception v13
...
.method private resetSelectedPriority()V
    .locals 5
...
.method selectNetwork(I)Z
    ...
    :cond_4
    invoke-direct {p0}, Landroid/net/wifi/WifiConfigStore;->resetSelectedPriority()V
