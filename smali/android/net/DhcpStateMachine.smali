...
.field public static final CMD_POPULATE_DHCP:I = 0x30008
...
.method private isLinkLocal(Landroid/net/DhcpResults;)Z
    .locals 3
...
.method private populateDhcp()V
    ...
    invoke-static {v1, v0}, Landroid/net/NetworkUtils;->populateDhcp(Ljava/lang/String;Landroid/net/DhcpResults;)Z
    ...
    invoke-virtual {v1, v0}, Landroid/net/DhcpResults;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v2, v3, v4, v0}, Lcom/android/internal/util/StateMachine;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method private runDhcp(Landroid/net/DhcpStateMachine$DhcpAction;)Z
    ...
    invoke-direct {p0, v0}, Landroid/net/DhcpStateMachine;->isLinkLocal(Landroid/net/DhcpResults;)Z
