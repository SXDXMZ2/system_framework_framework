...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v5, v6}, Landroid/net/CaptivePortalTracker;->access$2800(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    invoke-static {v5, v2}, Landroid/net/CaptivePortalTracker;->access$2900(Landroid/net/CaptivePortalTracker;Ljava/net/InetAddress;)Z
    ...
    # invokes: Lcom/android/internal/util/StateMachine;->log(Ljava/lang/String;)V
    invoke-static {v4, v5}, Landroid/net/CaptivePortalTracker;->access$3000(Landroid/net/CaptivePortalTracker;Ljava/lang/String;)V
    ...
    # getter for: Landroid/net/CaptivePortalTracker;->mNetworkInfo:Landroid/net/NetworkInfo;
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$1100(Landroid/net/CaptivePortalTracker;)Landroid/net/NetworkInfo;

    move-result-object v5

    # invokes: Landroid/net/CaptivePortalTracker;->notifyPortalCheckCompleted(Landroid/net/NetworkInfo;Z)V
    invoke-static {v4, v5, v0}, Landroid/net/CaptivePortalTracker;->access$3200(Landroid/net/CaptivePortalTracker;Landroid/net/NetworkInfo;Z)V
    ...
    # invokes: Landroid/net/CaptivePortalTracker;->setNotificationVisible(Z)V
    ...
    invoke-static {v5}, Landroid/net/CaptivePortalTracker;->access$3300(Landroid/net/CaptivePortalTracker;)Lcom/android/internal/util/State;

    move-result-object v5

    # invokes: Lcom/android/internal/util/StateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v4, v5}, Landroid/net/CaptivePortalTracker;->access$3400(Landroid/net/CaptivePortalTracker;Lcom/android/internal/util/IState;)V
