...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .local v10, "_arg9":Landroid/app/backup/IFullBackupRestoreObserver;
    move-object v0, p0

    .line 234
    invoke-virtual/range {v0 .. v10}, Landroid/app/backup/IBackupManager$Stub;->fullBackupWithoutConfirm(Landroid/os/ParcelFileDescriptor;ZZZZZ[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/backup/IFullBackupRestoreObserver;)V
    ...
    .end local v10    # "_arg9":Landroid/app/backup/IFullBackupRestoreObserver;
    :cond_d
    const/4 v1, 0x0
    ...
    .line 318
    .local v11, "_result":Landroid/content/Intent;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    invoke-virtual {v11, p3, v0}, Landroid/content/Intent;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    .line 330
    .end local v1    # "_arg0":Ljava/lang/String;
    .end local v11    # "_result":Landroid/content/Intent;
    :sswitch_17
    const-string v0, "android.app.backup.IBackupManager"
    ...
    .line 346
    .local v11, "_result":Landroid/app/backup/IRestoreSession;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V

    .line 347
    if-eqz v11, :cond_16

    invoke-interface {v11}, Landroid/app/backup/IRestoreSession;->asBinder()Landroid/os/IBinder;
    ...
    .end local v1    # "_arg0":Ljava/lang/String;
    .end local v2    # "_arg1":Ljava/lang/String;
    .end local v11    # "_result":Landroid/app/backup/IRestoreSession;
    :sswitch_19
    const-string v0, "android.app.backup.IBackupManager"
