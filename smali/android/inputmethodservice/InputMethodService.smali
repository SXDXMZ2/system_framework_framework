...
# static fields
.field public static final ACTION_SOFTKEYBOARD_FOCUSED:Ljava/lang/String; = "com.sonymobile.intent.action.SOFTKEYBOARD_FOCUSED"

.field public static final ACTION_SOFTKEYBOARD_FOCUS_CHANGE:Ljava/lang/String; = "com.sonymobile.intent.action.ACTION_SOFTKEYBOARD_FOCUS_CHANGE"
...
.field public static final EXTRA_SOFTKEYBOARD_FOCUSED:Ljava/lang/String; = "com.sonymobile.intent.extra.SOFTKEYBOARD_FOCUSED"

.field public static final EXTRA_SOFTKEYBOARD_FOCUS_CHANGE:Ljava/lang/String; = "com.sonymobile.intent.extra.SOFTKEYBOARD_FOCUS_CHANGE"
...
.field private mFocusChangeReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$200(Landroid/inputmethodservice/InputMethodService;Z)V
    .locals 0
    .param p0, "x0"    # Landroid/inputmethodservice/InputMethodService;
    .param p1, "x1"    # Z
    ...
    .prologue
    .line 231
    invoke-direct {p0, p1}, Landroid/inputmethodservice/InputMethodService;->sendFocusBroadcast(Z)V
...
.method private registerFocusChangeReceiver()V
    .locals 3

    .prologue
    .line 1575
    iget-object v1, p0, Landroid/inputmethodservice/InputMethodService;->mFocusChangeReceiver:Landroid/content/BroadcastReceiver;

    if-nez v1, :cond_0

    .line 1576
    new-instance v1, Landroid/inputmethodservice/InputMethodService$3;

    invoke-direct {v1, p0}, Landroid/inputmethodservice/InputMethodService$3;-><init>(Landroid/inputmethodservice/InputMethodService;)V

    iput-object v1, p0, Landroid/inputmethodservice/InputMethodService;->mFocusChangeReceiver:Landroid/content/BroadcastReceiver;

    .line 1591
    new-instance v0, Landroid/content/IntentFilter;

    const-string v1, "com.sonymobile.intent.action.ACTION_SOFTKEYBOARD_FOCUS_CHANGE"

    invoke-direct {v0, v1}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    .line 1592
    .local v0, "focusChangeFilter":Landroid/content/IntentFilter;
    ...
    iget-object v2, p0, Landroid/inputmethodservice/InputMethodService;->mFocusChangeReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v1, v2, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    .line 1594
    .end local v0    # "focusChangeFilter":Landroid/content/IntentFilter;
    :cond_0
    return-void
.end method
...
.method private sendFocusBroadcast(Z)V
    .locals 2
    .param p1, "focused"    # Z
    ...
    const-string v1, "com.sonymobile.intent.action.SOFTKEYBOARD_FOCUSED"

    invoke-direct {v0, v1}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 1617
    .local v0, "windowIntent":Landroid/content/Intent;
    const-string v1, "com.sonymobile.intent.extra.SOFTKEYBOARD_FOCUSED"
...
.method private unregisterFocuseChangeReceiver()V
    .locals 2

    .prologue
    .line 1605
    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mFocusChangeReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v0, p0, Landroid/inputmethodservice/InputMethodService;->mFocusChangeReceiver:Landroid/content/BroadcastReceiver;
...
.method public hideWindow()V
    ...
    .line 1564
    invoke-direct {p0, v2}, Landroid/inputmethodservice/InputMethodService;->sendFocusBroadcast(Z)V

    .line 1566
    .end local v0    # "windowIntent":Landroid/content/Intent;
    :cond_0
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->unregisterFocuseChangeReceiver()V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v6, v7}, Landroid/view/Window;->closePanel(I)V
...
.method showWindowInner(Z)V
    ...
    .line 1531
    invoke-direct {p0, v7}, Landroid/inputmethodservice/InputMethodService;->sendFocusBroadcast(Z)V

    .line 1532
    invoke-direct {p0}, Landroid/inputmethodservice/InputMethodService;->registerFocusChangeReceiver()V
