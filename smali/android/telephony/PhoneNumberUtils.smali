...
.method private static isEmergencyNumberInternal(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string/jumbo v20, "ro.semc.ecclist.num"
    ...
    .line 1788
    .local v17, "semc_numbers":I
    const-string v3, "FFF"

    .line 1789
    .local v3, "C_MCC":Ljava/lang/String;
    const-string v4, "FFF"

    .line 1790
    .local v4, "C_MNC":Ljava/lang/String;
    ...
    const-string v20, "[WP1]PLMN ="

    move-object/from16 v0, v20

    invoke-static {v0, v12}, Landroid/telephony/Rlog;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 1793
    const-string v20, "[WP1]input num ="
    ...
    const-string/jumbo v21, "ro.semc.ecclist.number."
    ...
    .line 1801
    .local v13, "semc_ecc_number":Ljava/lang/String;
    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v21, "ro.semc.ecclist.plmn."
    ...
    .line 1803
    .local v14, "semc_ecc_number_plmn":Ljava/lang/String;
    const-string v15, "FFF"

    .line 1804
    .local v15, "semc_mcc":Ljava/lang/String;
    const-string v16, "FFF"

    .line 1807
    .local v16, "semc_mnc":Ljava/lang/String;
    ...
    .line 1822
    :cond_8
    const-string v20, "[WP1]The semc ecc list num ="

    move-object/from16 v0, v20

    invoke-static {v0, v13}, Landroid/telephony/Rlog;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 1823
    const-string v20, "[WP1]The semc ecc num plmn ="

    move-object/from16 v0, v20

    invoke-static {v0, v14}, Landroid/telephony/Rlog;->v(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 1829
    const-string v20, "[WP1]The semc ecc num MCC ="

    move-object/from16 v0, v20

    invoke-static {v0, v15}, Landroid/telephony/Rlog;->v(Ljava/lang/String;Ljava/lang/String;)I

    .line 1830
    const-string v20, "[WP1]The semc ecc num MNC ="
    ...
    .line 1840
    :cond_a
    const-string v20, "[WP1]SIM ready --> MCC match =="
    ...
    .line 1842
    :cond_b
    const-string v20, "[WP1]SIM ready --> MNC match =="
    ...
    .line 1844
    const-string v20, "[WP1]SIM ready --> Number match =="
    ...
    .line 1850
    .end local v13    # "semc_ecc_number":Ljava/lang/String;
    .end local v14    # "semc_ecc_number_plmn":Ljava/lang/String;
    .end local v15    # "semc_mcc":Ljava/lang/String;
    .end local v16    # "semc_mnc":Ljava/lang/String;
    :cond_d
    const-string v20, "[WP1]The Number does not match!, run original flow = "
    ...
    .line 1854
    .restart local v13    # "semc_ecc_number":Ljava/lang/String;
    const-string v20, "[WP1]The semc ecc list num ="
    ...
    .line 1856
    const-string v20, "[WP1]SIM not ready --> Number match =="
    ...
    .end local v13    # "semc_ecc_number":Ljava/lang/String;
    :cond_12
    const-string v20, "[WP1]The SEMC_ECC_list_Number is 0, run original flow directly = "
    ...
    const-string v21, "System property doesn\'t provide any emergency numbers. Use embedded logic for determining ones."
    ...
    .line 1891
    new-instance v19, Lcom/android/i18n/phonenumbers/ShortNumberUtil;

    invoke-direct/range {v19 .. v19}, Lcom/android/i18n/phonenumbers/ShortNumberUtil;-><init>()V

    .line 1892
    .local v19, "util":Lcom/android/i18n/phonenumbers/ShortNumberUtil;
    if-eqz p2, :cond_17
    ...
    .line 1898
    .end local v19    # "util":Lcom/android/i18n/phonenumbers/ShortNumberUtil;
    :cond_18
    if-eqz p2, :cond_1b
...
.method public static stringToCalledPartyBCD(Ljava/lang/String;)[B
    .locals 1
    .param p0, "number"    # Ljava/lang/String;

    .prologue
    .line 1002
    invoke-static {p0}, Landroid/telephony/PhoneNumberUtils;->stringToCalledPartyBCDHelper(Ljava/lang/String;)[B
...
.method private static stringToCalledPartyBCDHelper(Ljava/lang/String;)[B
    .locals 15
    .param p0, "number"    # Ljava/lang/String;
