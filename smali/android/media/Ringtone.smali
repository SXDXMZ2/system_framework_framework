...
.method private playFallbackRingtone()Z
    ...
    invoke-static {v0, v10}, Landroid/media/RingtoneManager;->getActualDefaultRingtoneUri(Landroid/content/Context;I)Landroid/net/Uri;
    ...
    const-string v2, "[FXN.ASD]IOException when closing afd in playFallbackRingtone()"
    ...
    const-string v1, "[FXN.ASD]IOException when closing afd in playFallbackRingtone()"
    ...
    .line 338
    .end local v7    # "e":Ljava/io/IOException;
    .end local v9    # "nfe":Landroid/content/res/Resources$NotFoundException;
    :catchall_0
    move-exception v0
...
.method public isRingtoneValid()Z
    .locals 2
