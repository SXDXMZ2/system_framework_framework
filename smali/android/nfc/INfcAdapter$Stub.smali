...
.field static final TRANSACTION_activeSwp:I = 0x12
...
.field static final TRANSACTION_getNfcCEFromHostInterface:I = 0x4
...
.field static final TRANSACTION_setMultiSERoutingTable:I = 0x16

.field static final TRANSACTION_setNdefPushCallback:I = 0xc

.field static final TRANSACTION_setP2pModes:I = 0xe

.field static final TRANSACTION_setSecureElementState:I = 0x14
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 77
    invoke-virtual {p0}, Landroid/nfc/INfcAdapter$Stub;->getNfcCEFromHostInterface()Landroid/nfc/INfcCEFromHost;

    move-result-object v3

    .line 78
    .local v3, "_result":Landroid/nfc/INfcCEFromHost;
    invoke-virtual {p3}, Landroid/os/Parcel;->writeNoException()V

    .line 79
    if-eqz v3, :cond_3

    invoke-interface {v3}, Landroid/nfc/INfcCEFromHost;->asBinder()Landroid/os/IBinder;
    ...
    .line 84
    .end local v3    # "_result":Landroid/nfc/INfcCEFromHost;
    :sswitch_5
    const-string v4, "android.nfc.INfcAdapter"
    ...
    .line 255
    .local v0, "_arg0":Ljava/lang/String;
    sget-object v4, Landroid/nfc/MultiSERoutingInfo;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p2, v4}, Landroid/os/Parcel;->createTypedArray(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;

    move-result-object v1

    check-cast v1, [Landroid/nfc/MultiSERoutingInfo;

    .line 256
    .local v1, "_arg1":[Landroid/nfc/MultiSERoutingInfo;
    invoke-virtual {p0, v0, v1}, Landroid/nfc/INfcAdapter$Stub;->setMultiSERoutingTable(Ljava/lang/String;[Landroid/nfc/MultiSERoutingInfo;)Z
